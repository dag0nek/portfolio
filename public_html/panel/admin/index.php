        ...
        <body>
            <?php
                ...
                function m($db) // matches
                {
                    ...
                    $res1 = mysqli_query($db, "SELECT mecze2v2.id, 2v2teamy.nazwa, (SELECT 2v2teamy.nazwa FROM 2v2teamy, mecze2v2 WHERE mecze2v2.id_team2 = 2v2teamy.id), data, wynik FROM 2v2teamy, mecze2v2 WHERE mecze2v2.id_team1 = 2v2teamy.id");
                    $res2 = mysqli_query($db, "SELECT mecze5v5.id, 5v5teamy.nazwa, (SELECT 5v5teamy.nazwa FROM 5v5teamy, mecze5v5 WHERE mecze5v5.id_team2 = 5v5teamy.id), data, wynik FROM 5v5teamy, mecze5v5 WHERE mecze5v5.id_team1 = 5v5teamy.id");
                ...
                function ma($db, $t) // metch adding
                {
                    ...
                    Drużyna 1
                    <input type = 'hidden' name = 'mt' value = '$t' />
                    <select name = 'team1'>";
                ...
                function maq($db) // metch adding query
                {
                    $tm = $_POST['tm'];
                    $team1 = $_POST['team1'];
                    $team2 = $_POST['team2'];
